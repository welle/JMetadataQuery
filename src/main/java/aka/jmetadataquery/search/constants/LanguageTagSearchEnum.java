...
public enum LanguageTagSearchEnum {
    ...
    @NonNull
    private final List<aka.jmetadataquery.search.constants.LanguageTagEnum> languageList = new ArrayList<>();
     ...
     */
    @NonNull
    public List<aka.jmetadataquery.search.constants.LanguageTagEnum> getLanguagesList() {
